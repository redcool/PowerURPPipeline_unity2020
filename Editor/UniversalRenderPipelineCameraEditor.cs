...
namespace UnityEditor.Rendering.Universal
{
    ...
    class UniversalRenderPipelineCameraEditor : CameraEditor
    {
        ...
        static class Styles
        {
            ...
            public static GUIContent colorSpaceUsage = EditorGUIUtility.TrTextContent("Color Space Usage","Rendering in which color space?");
        ...
        SerializedProperty m_AdditionalCameraDataColorSpaceUsage;
        ...
        void init(List<Object> additionalCameraData)
        {
            ...
            m_AdditionalCameraDataColorSpaceUsage = m_AdditionalCameraDataSO.FindProperty("m_ColorSpaceUsage");
        ...
        void DrawRenderingSettings(CameraRenderType camType, UniversalRenderPipelineAsset rpAsset)
        {
            ...
            if (m_RenderingSettingsFoldout.value)
            {
                ...
                EditorGUILayout.PropertyField(m_AdditionalCameraDataColorSpaceUsage, Styles.colorSpaceUsage);
