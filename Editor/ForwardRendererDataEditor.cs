...
namespace UnityEditor.Rendering.Universal
{
    ...
    [MovedFrom("UnityEditor.Rendering.LWRP")] public class ForwardRendererDataEditor : ScriptableRendererDataEditor
    {
        ...
        SerializedProperty m_UILayerMask;
        SerializedProperty m_VFXLayerMask;
        ...
        private void OnEnable()
        {
            ...
            m_UILayerMask = serializedObject.FindProperty("m_UILayerMask");
            m_VFXLayerMask = serializedObject.FindProperty("m_VFXLayerMask");
#if ENABLE_RENDERING_PATH_UI
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_UILayerMask,Styles.UIMask);
            EditorGUILayout.PropertyField(m_VFXLayerMask, Styles.VFXMask);
            EditorGUI.indentLevel--;
            EditorGUILayout.Space();
