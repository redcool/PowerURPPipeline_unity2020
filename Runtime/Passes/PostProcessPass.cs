...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public class PostProcessPass : ScriptableRenderPass
    {
        ...
        void Render(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            using (new ProfilingScope(cmd, ProfilingSampler.Get(URPProfileId.UberPostProcess)))
            {
...
#endif
                {
                    ...
                    if (finishPostProcessOnScreen  && !m_HasFinalPass)
                        CameraColorSpaceUsage.EnableColorSpace(cameraData, cmd, m_Materials.uber);
                    ...
                    if (!finishPostProcessOnScreen)
                    {
                        ...
                        CameraColorSpaceUsage.EnableColorSpace(cameraData, cmd, m_BlitMaterial);
        ...
        void RenderFinalPass(CommandBuffer cmd, ref RenderingData renderingData)
        {
...
#endif
            {
                ...
                if (!enableFSR)
                {
                    ...
                    CameraColorSpaceUsage.EnableColorSpace(cameraData, null, material);
                }
                ...
                {
                    CameraColorSpaceUsage.EnableColorSpace(cameraData, null, material);
                    DoFSR(cmd, ref cameraData, oldCameraTarget, material);
                }
            }
        }
        ...
        #region FSR
        void DoFSR(CommandBuffer cmd, ref CameraData cameraData, RenderTargetIdentifier dst,Material material)
        {
