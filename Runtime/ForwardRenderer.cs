...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed class ForwardRenderer : ScriptableRenderer
    {
        ...
        DrawObjectsPass m_RenderVFXPass;
        DrawObjectsPass m_RenderUIPass;
        FinalBlitPass m_BlitPass;
...
#pragma warning restore 414
        ...
        public ForwardRenderer(ForwardRendererData data) : base(data)
        {
...
#endif
            {
                ...
                m_RenderVFXPass = new DrawObjectsPass(URPProfileId.DrawVFXObjects, false, RenderPassEvent.BeforeRenderingTransparents, RenderQueueRange.transparent, data.VFXLayerMask, m_DefaultStencilState, stencilData.stencilReference);
                m_RenderUIPass = new DrawObjectsPass(URPProfileId.DrawUIObjects, false, RenderPassEvent.AfterRenderingTransparents, RenderQueueRange.transparent, data.UILayerMask, m_DefaultStencilState, stencilData.stencilReference);
            }
            ...
            m_BlitPass = new FinalBlitPass(RenderPassEvent.AfterRendering+1,m_BlitMaterial);
#if UNITY_EDITOR
